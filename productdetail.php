...
$sel = mysqli_query($conn, "select * from item where del=0 and productid=$_SESSION[proid]");
$sell = mysqli_fetch_array($sel);

if (isset($_REQUEST[sendreview])) {
    $date = date('Y-m-d h:i:s');
    $insert = mysqli_query($conn, "insert into reviewproduct values('$_SESSION[user]','$_SESSION[proid]',0,'$_REQUEST[revmsg]','$date',0,0)");
}

$ch=  mysqli_query($conn, "select * from wishlist where userid like '$_SESSION[user]' and productid=$_SESSION[proid]");
...
if(isset($_REQUEST[sendwish]))
{
    if($bharelo!=1)
    {
        mysqli_query($conn, "insert into wishlist values('$_SESSION[user]',$_SESSION[proid],0)");
}
}
...
{
    $inq=mysqli_query($conn, "insert into inquiry values($sell[1],$_SESSION[proid],0,'$_REQUEST[name]','$_REQUEST[contact]','$_REQUEST[email]','$_REQUEST[message]',0)");
}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12  ">
                                ...
                                <div class="detaildekho fffont">
                                         ...
                                         <?php 
                                    $of=  mysqli_query($conn, "select * from offer where del=0 and storeid=$prodel1[7]");
                            ...
                            <div class="col-md-5">
                             ...
                             <div class="row">
                                    ...
                                    <label class="mylbm ffont">Coupon Discount For You  &nbsp;&nbsp;&nbsp;<i class="fa fa-caret-down"></i></label>
                                        ...
                                        if($_SESSION[user]!="")
                                        {
                                            $tot=  mysqli_query($conn, "select sum(finalamount) from bill where userid like '$_SESSION[user]' ");
...
<?php
$info1 = mysqli_query($conn, "select count(*) from user r,reviewproduct rw where r.userid=rw.userid and rw.productid=$_SESSION[proid] and rw.active=1");
...
$info = mysqli_query($conn, "select r.username,r.url,rw.* from user r,reviewproduct rw where r.userid=rw.userid and rw.productid=$_SESSION[proid] and rw.active=1 limit $s,5");
...
?>
                ...
                <div class="container">
                    ...
                    <div class="row">
                         <?php
                         $rt=mysqli_query ($conn, "select * from item where mcatid=$sell[0]");
