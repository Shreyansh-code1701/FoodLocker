...
if (isset($_REQUEST[send])) 
    {
         $insert =mysqli_query($conn, "insert into feedbackstore values($_REQUEST[storeid],0,'$_REQUEST[name]','$_REQUEST[sms]')");
}
?>
<!DOCTYPE html>
    ...
    <body class="smooth-scroll" onload="misscon('missfeedbackstore',0);">
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                         ...
                         <?php
                                                            $feedbackstore=mysqli_query($conn, "select * from store where del=0 and active=1");
                        ...
                        <select class="form-control combocap" style="border: 2px dotted #f8a631;" name="storeid"  onchange="misscon('missfeedbackstore',this.value);">
                                                            ...
                                                            <?php
                                                                while($feedstore=  mysqli_fetch_array($feedbackstore))
                                                                {
                                                             ?>
