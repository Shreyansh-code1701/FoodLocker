...
if ($_REQUEST[tbl] == "state") 
{
    ...
    {
        mysqli_query("update state set del = 0 where stateid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from state where del = 1");
        }
        else 
        {
            mysqli_query("delete from state where stateid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from state where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from state where del=1 order by statename  limit $st,$pp");
...
if ($_REQUEST[tbl] == "city") 
{
    if($_REQUEST[work]=="restore")
    {
        mysqli_query("update city set del = 0 where cityid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from city where del = 1");
        }
        else 
        {
            mysqli_query("delete from city where cityid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from city where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from city where del=1 order by cityname  limit $st,$pp");
    while ($row = mysqli_fetch_array($get)) 
        {
        $c++;
        ?>
...
if ($_REQUEST[tbl] == "area") 
{
    if($_REQUEST[work]=="restore")
    {
        mysqli_query("update area set del = 0 where areaid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from area where del = 1");
        }
        else 
        {
            mysqli_query("delete from area where areaid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from area where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from area where del=1 order by areaname  limit $st,$pp");
    while ($row = mysqli_fetch_array($get)) 
        {
        $c++;
        ?>
...
if ($_REQUEST[tbl] == "maincategory") 
{
    if($_REQUEST[work]=="restore")
    {
        mysqli_query("update maincategory set del = 0 where mcatid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from mainctegory where del = 1");
        }
        else 
        {
            mysqli_query("delete from maincategory where mcatid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from maincategory where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from maincategory where del=1 order by mcatname  limit $st,$pp");
    while ($row = mysqli_fetch_array($get)) 
        {
        $c++;
        ?>
...
if ($_REQUEST[tbl] == "storetype") 
{
    if($_REQUEST[work]=="restore")
    {
        mysqli_query("update storetype set del = 0 where typeid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from storetype where del = 1");
        }
        else 
        {
            mysqli_query("delete from storetype where typeid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from storetype where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from storetype where del=1 order by typename  limit $st,$pp");
    while ($row = mysqli_fetch_array($get)) 
        {
        $c++;
        ?>
...
if ($_REQUEST[tbl] == "timeperiod") 
{
    if($_REQUEST[work]=="restore")
    {
        mysqli_query("update timeperiod set del = 0 where timeperiodid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from timeperiod where del = 1");
        }
        else 
        {
            mysqli_query("delete from timeperiod where timeperiodid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from timeperiod where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from timeperiod where del=1 order by timeperiod  limit $st,$pp");
    while ($row = mysqli_fetch_array($get)) 
        {
        $c++;
        ?>
...
if ($_REQUEST[tbl] == "adprice") 
{
    if($_REQUEST[work]=="restore")
    {
        mysqli_query("update adprice set del = 0 where priceid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from adprice where del = 1");
        }
        else 
        {
            mysqli_query("delete from adprice where priceid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from adprice where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from adprice where del=1 order by price  limit $st,$pp");
    while ($row = mysqli_fetch_array($get)) 
        {
        $c++;
        ?>
...
if ($_REQUEST[tbl] == "event") 
{
    if($_REQUEST[work]=="restore")
    {
        mysqli_query("update event set del = 0 where eventid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from event where del = 1");
        }
        else 
        {
            mysqli_query("delete from event where eventid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from event where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from event where del=1 order by eventname  limit $st,$pp");
    while ($row = mysqli_fetch_array($get)) 
        {
        $c++;
        ?>
...
if ($_REQUEST[tbl] == "paymethod") 
{
    if($_REQUEST[work]=="restore")
    {
        mysqli_query("update paymethod set del = 0 where payid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from paymethod where del = 1");
        }
        else 
        {
            mysqli_query("delete from paymethod where payid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from paymethod where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from paymethod where del=1 order by payname  limit $st,$pp");
    while ($row = mysqli_fetch_array($get)) 
        {
        $c++;
        ?>
...
if ($_REQUEST[tbl] == "highlight") 
{
    if($_REQUEST[work]=="restore")
    {
        mysqli_query("update highlight set del = 0 where highlightid = $_REQUEST[id]");
    }
    if($_REQUEST[work]=="delete")
    {
        if($_REQUEST[id]=="all")
        {
            mysqli_query("delete from highlight where del = 1");
        }
        else 
        {
            mysqli_query("delete from highlight where highlightid = $_REQUEST[id]");
        }
    }
    
        $in = mysqli_query("select count(*) from highlight where del=1 ");
...
//    echo $a[0];
    ...
    <?php
    $c = $st;
    $get = mysqli_query("select * from highlight where del=1 order by highlightname  limit $st,$pp");
    while ($row = mysqli_fetch_array($get)) 
        {
        $c++;
        ?>
