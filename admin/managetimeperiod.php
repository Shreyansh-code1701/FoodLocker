...
{
     $get = mysqli_query("select * from timeperiod where timeperiodname like '$_REQUEST[timeperiod]' and price=$_REQUEST[price]");
    $g = mysqli_fetch_array($get);

    if ($g[0] == "") {
        $ins = mysqli_query("insert into timeperiod values(0,'$_REQUEST[timeperiod]',$_REQUEST[price],0,$_REQUEST[days])");
    }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
    else
    {
        $er=1;
...
{
     $get = mysqli_query("select * from timeperiod where timeperiodname like '$_REQUEST[timeperiodupdate]' and cost=$_REQUEST[pricetupdate]");
    $g = mysqli_fetch_array($get);

    if ($g[0] == "") {
        $ins = mysqli_query("update timeperiod set timeperiodname='$_REQUEST[timeperiodupdate]',price=$_REQUEST[priceupdate],days=$_REQUEST[updays] where timeperiodid=$_SESSION[uid] ");
    }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
    else
    {
        $er1=1;
