...
{
     $get = mysqli_query($conn,"select * from duration where durationtime like '$_REQUEST[duration]' and cost=$_REQUEST[cost]");
    $g = mysqli_fetch_array($get);

    if ($g[0] == "") {
        $ins = mysqli_query($conn,"insert into duration values(0,'$_REQUEST[duration]',$_REQUEST[cost],0,$_REQUEST[months])");
    }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
    else
    {
        $er=1;
...
{
     $get = mysqli_query($conn,"select * from duration where durationtime like '$_REQUEST[durationupdate]' and cost=$_REQUEST[costupdate]");
    $g = mysqli_fetch_array($get);

    if ($g[0] == "") {
        $ins = mysqli_query($conn,"update duration set durationtime='$_REQUEST[durationupdate]',cost=$_REQUEST[costupdate], months=$_REQUEST[updatemonths] where durationid=$_SESSION[uid]");
    }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
    else
    {
        $er1=1;
