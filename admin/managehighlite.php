...
if (isset($_REQUEST[send])) {
    $get = mysqli_query($conn,"select * from highlight where highlightname like '$_REQUEST[highlight]'");
    $g = mysqli_fetch_array($get);

    if ($g[0] == "") {
        $ins = mysqli_query($conn,"insert into highlight values(0,'$_REQUEST[highlight]',0)");
    } else {
        $er = 1;
    }
}
