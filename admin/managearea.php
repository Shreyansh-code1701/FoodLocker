...
{
    $get = mysqli_query($conn,"select * from area where areaname like '$_REQUEST[area]'");
    $g = mysqli_fetch_array($get);

    if ($g[0] == "") {
        $ins = mysqli_query($conn,"insert into area values($_REQUEST[cityid],0,'$_REQUEST[area]',0)");
    } else {
        $er = 1;
    }
}
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select required="" name="cityid" class="form-control">
                                                ...
                                                <?php
                                                $get=mysqli_query($conn,"select * from city");
