...
if ($_REQUEST[tbl] == "state") {
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from state where statename like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update state set statename = '$_REQUEST[v]' where stateid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("update state set del =1");
        } else {
            mysqli_query("update state set del =1 where stateid = $_REQUEST[id]");
        }
    }


    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from state where del=0 ");
    } else {
        $in = mysqli_query("select count(*) from state where del=0 and statename like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
//    echo $a[0];
    $pp = $_REQUEST[pp];
    $p = $_REQUEST[p];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from state where del=0 order by statename limit $st,$pp");
    } else {
        $get = mysqli_query("select * from state where del=0 and statename like '%$_REQUEST[find]%'   limit $st,$pp");
    }
...
if ($_REQUEST[tbl] == "city") {
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from city where cityname like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update city set cityname = '$_REQUEST[v]' where cityid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("update city set del =1");
        } else {
            mysqli_query("update city set del =1 where cityid = $_REQUEST[id]");
        }
    }


    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from city where del=0 ");
    } else {
        $in = mysqli_query("select count(*) from city where del=0 and cityname like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
//    echo $a[0];
    $pp = $_REQUEST[pp];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from city where del=0 order by cityname  limit $st,$pp");
    } else {
        $get = mysqli_query("select * from city where del=0 and cityname like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
...
if ($_REQUEST[tbl] == "area") {
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from area where areaname like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update area set areaname = '$_REQUEST[v]' where areaid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("update area set del =1");
        } else {
            mysqli_query("update area set del =1 where areaid = $_REQUEST[id]");
        }
    }


    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from area where del=0 ");
    } else {
        $in = mysqli_query("select count(*) from area where del=0 and areaname like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
//    echo $a[0];
    $pp = $_REQUEST[pp];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from area where del=0 order by areaname limit $st,$pp");
    } else {
        $get = mysqli_query("select * from area where del=0 and areaname like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[1]) {
...
if ($_REQUEST[tbl] == "maincategory") {
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from maincategory where mcatname like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update maincategory set mcatname = '$_REQUEST[v]' where mcatid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("update maincategory set del =1");
        } else {
            mysqli_query("update maincategory set del =1 where mcatid = $_REQUEST[id]");
        }
    }


    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from maincategory where del=0 ");
    } else {
        $in = mysqli_query("select count(*) from maincategory where del=0 and mcatname like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
//    echo $a[0];
    $pp = $_REQUEST[pp];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from maincategory where del=0 order by mcatname  limit $st,$pp");
    } else {
        $get = mysqli_query("select * from maincategory where del=0 and mcatname like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[0]) {
...
if ($_REQUEST[kona] == "form") {
    if ($_REQUEST[konu] == "duration") {
        if ($_REQUEST[sukam] == "insert") {
            ...
            $in = mysqli_query("select * from duration where del=0 and durationid=$_REQUEST[id]");
            $du = mysqli_fetch_array($in);
            ?>
            <div class="form-group">
                <div class="input-group">
...
if ($_REQUEST[kona] == "data") {
    if ($_REQUEST[konu] == "duration") {
        ...
        if ($_REQUEST[recid] != 0) {
            $up = mysqli_query("update duration set del=1 where durationid=$_REQUEST[recid]");
        }

        if ($_REQUEST[delid] == 'badhurec') {
            $del = mysqli_query("update duration set del=1 where del=0");
        }

        $pp = 8;
        $d = mysqli_query("select count(durationid) from duration where del=0");
        ...
        if ($_REQUEST[ketla] == "all") {
            $data = mysqli_query("select * from duration where del=0  order by durationtime limit $st,$pp ");
        } else {
            $data = mysqli_query("select * from duration where del=0 and durationtime like '%$_REQUEST[ketla]%'");
        }
        ...
        while ($row = mysqli_fetch_array($data)) {
            ...
            if ($page > 4) {
                ...
                if ($_REQUEST[kona] == "recdata") {
                    if ($_REQUEST[konu] == "duration") {
                        if ($_REQUEST[recid] != 0) {
                            $up = mysqli_query("update duration set del=0 where durationid=$_REQUEST[recid]");
                        }
                        if ($_REQUEST[delid] != 0) {
                            $del = mysqli_query("delete from duration where durationid=$_REQUEST[delid]");
                        }
                        if ($_REQUEST[badhudel] == "badhu") {
                            $del = mysqli_query("delete from duration where del=1");
                        }
                        $pp = 8;
                        $d1 = mysqli_query("select count(durationid) from duration where del=1");
                        $dd1 = mysqli_fetch_array($d1);
        ...
        <?php
        $c = 0;
        $data = mysqli_query("select * from duration where del=1  order by durationtime limit $st,$pp ");
...
<!----------------------------------------MANAGE STORE TYPE----------------------------------------->
                ...
                if ($_REQUEST[tbl] == "storetype") {
                    if ($_REQUEST[work] == "update") {
                        $get = mysqli_query("select * from storetype where typename like '$_REQUEST[v]'");
                        $g = mysqli_fetch_array($get);

                        if ($g[0] == "") {
                            mysqli_query("update storetype set typename = '$_REQUEST[v]' where typeid = $_REQUEST[id]");
                        }
                    }
                    if ($_REQUEST[work] == "delete") {
                        if ($_REQUEST[id] == "all") {
                            mysqli_query("update storetype set del =1");
                        } else {
                            mysqli_query("update storetype set del =1 where typeid = $_REQUEST[id]");
                        }
                    }


                    if ($_REQUEST[find] == "") {
                        $in = mysqli_query("select count(*) from storetype where del=0 ");
                    } else {
                        $in = mysqli_query("select count(*) from storetype where del=0 and typename like '%$_REQUEST[find]%'  ");
                    }
                    $a = mysqli_fetch_array($in);
//    echo $a[0];
                    $pp = $_REQUEST[pp];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from storetype where del=0 order by typename  limit $st,$pp");
    } else {
        $get = mysqli_query("select * from storetype where del=0 and typename like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[0]) {
...
if ($_REQUEST[tbl] == "subscriber") {
    ...
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from subscriber where email like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update subscriber set email = '$_REQUEST[v]' where sid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("delete from subscriber ");
        } else {
            mysqli_query("delete from subscriber where sid = $_REQUEST[id]");
        }
    }


    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from subscriber");
    } else {
        $in = mysqli_query("select count(*) from subscriber where email like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
//    echo $a[0];
    $pp = $_REQUEST[pp];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from subscriber  order by email  limit $st,$pp");
    } else {
        $get = mysqli_query("select * from subscriber where  email like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[0]) {
...
if ($_REQUEST[tbl] == "contactus") {
    ...
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from contactus where contactname like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update contactus set contactname = '$_REQUEST[v]' where contactid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("delete from contactus ");
        } else {
            mysqli_query("delete from contactus where contactid = $_REQUEST[id]");
        }
    }


    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from contactus");
    } else {
        $in = mysqli_query("select count(*) from contactus where contactname like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
    $pp = $_REQUEST[pp];
    $p = $_REQUEST[p];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from contactus  order by contactname  limit $st,$pp");
    } else {
        $get = mysqli_query("select * from contactus where contactname like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[0]) {
...
if ($_REQUEST[tbl] == "feedback") {
    ...
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from feedback where feedbackname like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update feedback set feedbackname = '$_REQUEST[v]' where feedbackid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            ...
            mysqli_query("delete from feedback where feedbackid = $_REQUEST[id]");
        }
    }


    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from feedback");
    } else {
        $in = mysqli_query("select count(*) from feedback where feedbackname like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
    $pp = $_REQUEST[pp];
    $p = $_REQUEST[p];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from feedback  order by feedbackname  limit $st,$pp");
    } else {
        $get = mysqli_query("select * from feedback where feedbackname like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[0]) {
...
if ($_REQUEST[kona] == "form") {
    if ($_REQUEST[konu] == "timeperiod") {
        if ($_REQUEST[sukam] == "insert") {
            ...
            $_SESSION[uid] = $_REQUEST[id];
            $in = mysqli_query("select * from timeperiod where del=0 and timeperiodid=$_REQUEST[id]");
            $du = mysqli_fetch_array($in);
            ?>
            <div class="form-group">
                <div class="input-group">
...
if ($_REQUEST[kona] == "data") {
    if ($_REQUEST[konu] == "timeperiod") {
        ...
        if ($_REQUEST[recid] != 0) {
            $up = mysqli_query("update timeperiod set del=1 where timeperiodid=$_REQUEST[recid]");
        }

        if ($_REQUEST[delid] == 'badhurec') {
            $del = mysqli_query("update timeperiod set del=1 where del=0");
        }

        $pp = 8;
        $d = mysqli_query("select count(timeperiodid) from timeperiod where del=0");
        $dd = mysqli_fetch_array($d);
        $_SESSION[durationcount] = $dd[0];
        $page = ceil($_SESSION[durationcount] / $pp);
        ...
        $c = 0;
        if ($_REQUEST[ketla] == "all") {
            $data = mysqli_query("select * from timeperiod where del=0  order by timeperiodname limit $st,$pp ");
        } else {
            $data = mysqli_query("select * from timeperiod where del=0 and timeperiodname like '%$_REQUEST[ketla]%'");
        }
        ...
        while ($row = mysqli_fetch_array($data)) {
            ...
            if ($page > 4) {
                ...
                if ($_REQUEST[kona] == "recdata") {
                    if ($_REQUEST[konu] == "timeperiod") {
                        if ($_REQUEST[recid] != 0) {
                            $up = mysqli_query("update timeperiod set del=0 where timeperiodid=$_REQUEST[recid]");
                        }
                        if ($_REQUEST[delid] != 0) {
                            $del = mysqli_query("delete from timeperiod where timeperiodid=$_REQUEST[delid]");
                        }
                        if ($_REQUEST[badhudel] == "badhu") {
                            $del = mysqli_query("delete from timeperiod where del=1");
                        }
                        $pp = 8;
                        $d1 = mysqli_query("select count(timeperiodid) from timeperiod where del=1");
                        $dd1 = mysqli_fetch_array($d1);
                        $_SESSION[durationreccount] = $dd1[0];
                        $page = ceil($_SESSION[durationreccount] / $pp);
        ...
        <?php
        $c = 0;
        $data = mysqli_query("select * from timeperiod where del=1  order by timeperiodname limit $st,$pp ");
...
if ($_REQUEST[tbl] == "user") {
    ...
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from user where username like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update user set username = '$_REQUEST[v]' where userid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("delete from user ");
        } else {
            mysqli_query("delete from user where userid like '$_REQUEST[id]'");
        }
    }

    if ($_REQUEST[work] == "block") {
        $inb = mysqli_query("select * from login where userid like '$_REQUEST[id]'");
        $inbb = mysqli_fetch_array($inb);
        if ($inbb[4] == 0) {
            $b = mysqli_query("update login set block=1 where userid like '$_REQUEST[id]'");
        } else {
            $b = mysqli_query("update login set block=0 where userid like '$_REQUEST[id]'");
        }
    }

    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from user");
    } else {
        $in = mysqli_query("select count(*) from user where username like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
    $pp = $_REQUEST[pp];
    $p = $_REQUEST[p];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from user where type=2  order by username  limit $st,$pp");
    } else {
        $get = mysqli_query("select * from user where type=2 and username like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[8]) {
            ...
            <?php
            $g = mysqli_query("select * from login where userid like '$row[8]'");
...
if ($_REQUEST[tbl] == "seller") {
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from user where type=1  order by username  limit $st,$pp");
    } else {
        $get = mysqli_query("select * from user where type=1 and username like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[8]) {
...
<!----------------------------------------MANAGE EVENT----------------------------------------->
        ...
        if ($_REQUEST[tbl] == "event") {
            if ($_REQUEST[work] == "update") {
                $get = mysqli_query("select * from event where eventname like '$_REQUEST[v]'");
                $g = mysqli_fetch_array($get);

                if ($g[0] == "") {
                    mysqli_query("update event set eventname = '$_REQUEST[v]' where eventid = $_REQUEST[id]");
                }
            }
            if ($_REQUEST[work] == "delete") {
                if ($_REQUEST[id] == "all") {
                    mysqli_query("update event set del =1");
                } else {
                    mysqli_query("update event set del =1 where eventid = $_REQUEST[id]");
                }
            }


            if ($_REQUEST[find] == "") {
                $in = mysqli_query("select count(*) from event where del=0 ");
            } else {
                $in = mysqli_query("select count(*) from event where del=0 and eventname like '%$_REQUEST[find]%'  ");
            }
            $a = mysqli_fetch_array($in);
//    echo $a[0];
            $pp = $_REQUEST[pp];
    ...
    <table class="table table-responsive table-hover mytable">
        ...
        <th></th>
                ...
                $c = $st;
                if ($_REQUEST[find] == "") {
                    $get = mysqli_query("select * from event where del=0 order by eventname limit $st,$pp");
                } else {
                    $get = mysqli_query("select * from event where del=0 and eventname like '%$_REQUEST[find]%'   limit $st,$pp");
                }
                while ($row = mysqli_fetch_array($get)) {
                    $c++;
                    if ($_REQUEST[uid] == $row[0]) {
...
if ($_REQUEST[tbl] == "paymethod") {
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from paymethod where payname like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update paymethod set payname = '$_REQUEST[v]' where payid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("update paymethod set del =1");
        } else {
            mysqli_query("update paymethod set del =1 where payid = $_REQUEST[id]");
        }
    }


    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from paymethod where del=0 ");
    } else {
        $in = mysqli_query("select count(*) from paymethod where del=0 and payname like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
//    echo $a[0];
    $pp = $_REQUEST[pp];
    ...
    <table class="table table-responsive table-hover mytable">
        ...
        <th></th>
                ...
                $c = $st;
                if ($_REQUEST[find] == "") {
                    $get = mysqli_query("select * from paymethod where del=0 order by payname limit $st,$pp");
                } else {
                    $get = mysqli_query("select * from paymethod where del=0 and payname like '%$_REQUEST[find]%'   limit $st,$pp");
                }
                while ($row = mysqli_fetch_array($get)) {
                    $c++;
                    if ($_REQUEST[uid] == $row[0]) {
...
if ($_REQUEST[konu] == 'missbill') {
    ...
    if ($_REQUEST[stid] != 0) {
        ...
        $s = mysqli_query("select durationid from store where storeid=$_REQUEST[stid]");
        $ss = mysqli_fetch_array($s);
        
        $dn=mysqli_query("select months from duration where durationid=$ss[0]");
        $dnn=mysqli_fetch_array($dn);
        $dd=date('Y-m-d',strtotime('+'.$dnn[0]. 'month'));
        
        //echo $dd;
       $in = mysqli_query("insert into packagebill values($ss[0],$_REQUEST[stid],0,'$bdate')");
        
      $up = mysqli_query("update store set active=1,startingdate='$bdate',endingdate='$dd' where storeid=$_REQUEST[stid]");
    }

    if ($_REQUEST[kona] == 'today') {
        $bdate = date('Y-m-d');
        $sel = mysqli_query("select st.statename,c.cityname,a.areaname,s.* from state st,city c,area a,store s where st.stateid=s.stateid and c.cityid=s.cityid and a.areaid=s.areaid and s.regdate like '$bdate'");
       
        $su = mysqli_query("select count(storeid) from store where regdatedate like '$bdate'");
        $sell = mysqli_fetch_array($su);
    } else {
        $sel = mysqli_query("select st.statename,c.cityname,a.areaname,s.* from state st,city c,area a,store s where st.stateid=s.stateid and c.cityid=s.cityid and a.areaid=s.areaid and s.storeid =$_REQUEST[kona]");
        
        $su = mysqli_query("select count(storeid) from store where storeid =$_REQUEST[kona]");
        $sell = mysqli_fetch_array($su);
        }
    ...
    while ($row = mysqli_fetch_array($sel)) {
         ...
         $bsel =mysqli_query("select * from user where userid like '$row[5]' ");
          $bbsel = mysqli_fetch_array($bsel);

          $packbil=  mysqli_query("select packagebillid from packagebill where storeid=$row[6]");
          $packbill = mysqli_fetch_array($packbil); 
        ...
        <table class="table table-responsive" style="background:url(../seller/images/food.png) no-repeat 50% 50%;" >
            ...
            <?php
            $selg= mysqli_query("select * from duration where durationid=$row[4]");
            $gg = mysqli_fetch_array($selg);
            ?>
...
if ($_REQUEST[kona] == "data") {
    if ($_REQUEST[konu] == "addbanner") {
        ...
        if ($_REQUEST[active] != "") {
            ...
            $act = mysqli_query("select * from addbanner where adid=$_REQUEST[active]");
            $actt = mysqli_fetch_array($act);
            if ($actt[8] == 0) {

                $ac = mysqli_query("update addbanner set active=1 where adid=$_REQUEST[active]");
            } else
                {
                    $ac = mysqli_query("update addbanner set active=0 where adid=$_REQUEST[active]");
                }
        }

        if ($_REQUEST[recid] != 0) {
            $up = mysqli_query("update addbanner set del=1 where adid=$_REQUEST[recid]");
        }

        if ($_REQUEST[delid] == 'badhurec') {
            $del = mysqli_query("update addbanner set del=1 where del=0");
        }

        $pp = 8;
        $d = mysqli_query("select count(adid) from addbanner where del=0");
        $dd = mysqli_fetch_array($d);
        $_SESSION[durationcount] = $dd[0];
        $page = ceil($_SESSION[durationcount] / $pp);
        ...
        if ($_REQUEST[ketla] == "all") {
            ...
            $data = mysqli_query("select * from addbanner where del=0  limit $st,$pp ");
        } else {
            $data = mysqli_query("select * from addbanner where adbannername like '$_REQUEST[ketla]%'");
        }
...
if ($_REQUEST[konu] == 'missbannerbill') {
    ...
    if ($_REQUEST[stid] != 0) {
        $bdate = date('Y-m-d');
        $s = mysqli_query("select timeperiodid from addbanner where adid=$_REQUEST[id]");
        $ss = mysqli_fetch_array($s);

        $in =mysqli_query("insert into bannerbill values($ss[0],$_REQUEST[stid],0,'$bdate')");
      
        $dnn=mysqli_query("select days from timeperiod where timeperiodid=$ss[0]");
        $dn1=mysqli_fetch_array($dnn);
        $dd=date('Y-m-d',strtotime('+'.$dn1[0]. 'day'));
        
       $up = mysqli_query("update addbanner set startdate='$bdate',enddate='$dd',active=1 where adid=$_REQUEST[id]");
    }
    ...
    if ($_REQUEST[kona] == 'today') {
        $bdate = date('Y-m-d');
        $sel = mysqli_query("select u.username,s.storename,s.address,a.* from user u,store s,addbanner a where a.storeid = s.storeid and u.userid=s.userid and uploaddate like '$bdate'");

        $su = mysqli_query("select count(adid) from addbanner where uploaddate like '$bdate'");
        $sell = mysqli_fetch_array($su);
        
    } else {
        
        $sel = mysqli_query("select u.username,s.storename,s.address,a.* from user u,store s,addbanner a where a.storeid = s.storeid and u.userid=s.userid and  a.storeid =$_REQUEST[kona]");
        
        $su = mysqli_query("select count(adid) from addbanner where storeid =$_REQUEST[kona]");
        $sell = mysqli_fetch_array($su);
        }
    ...
    while ($row = mysqli_fetch_array($sel)) {
         ...
         $b=mysqli_query("select username from user where userid like '$row[6]' ");
          $bb= mysqli_fetch_array($b);

          $packbill=  mysqli_query("select bannerbillid from bannerbill where storeid=$row[3]");
          $banbi = mysqli_fetch_array($packbill); 
        ...
        if ($row[11] == 1) {
            ...
            <?php
            $selg = mysqli_query("select * from timeperiod where timeperiodid=$row[4]");
            $gg = mysqli_fetch_array($selg);
            ?>
...
if ($_REQUEST[tbl] == "highlight") {
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from highlight where highlightname like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update highlight set highlightname = '$_REQUEST[v]' where highlightid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("update highlight set del =1");
        } else {
            mysqli_query("update highlight set del =1 where highlightid = $_REQUEST[id]");
        }
    }


    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from highlight where del=0 ");
    } else {
        $in = mysqli_query("select count(*) from highlight where del=0 and highlightname like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
//    echo $a[0];
    $pp = $_REQUEST[pp];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select * from highlight where del=0 order by highlightname limit $st,$pp");
    } else {
        $get = mysqli_query("select * from highlight where del=0 and highlightname like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[0]) {
...
?>
    ...
    $c = 0;
            ...
            {
                $data1=mysqli_query("select s.storename,d.durationtime,d.cost,b.billdate from store s,duration d,packagebill b where s.storeid=b.storeid and d.durationid=s.durationid and d.durationid=b.durationid");
            }
            if($_REQUEST[koni]=="business")
            {
                $data1=mysqli_query("select s.storename,d.durationtime,d.cost,b.billdate from store s,duration d,packagebill b where s.storeid=b.storeid and d.durationid=s.durationid and d.durationid=b.durationid and s.storename like '$_REQUEST[su]%' ");
            }
             if($_REQUEST[koni]=="duration")
            {
                $data1=mysqli_query("select s.storename,d.durationtime,d.cost,b.billdate from store s,duration d,packagebill b where s.storeid=b.storeid and d.durationid=s.durationid and d.durationid=b.durationid and d.durationtime like '$_REQUEST[su]%' ");
            }
             if($_REQUEST[koni]=="amout")
            {
                $data1=mysqli_query("select s.storename,d.durationtime,d.cost,b.billdate from store s,duration d,packagebill b where s.storeid=b.storeid and d.durationid=s.durationid and d.durationid=b.durationid and d.cost like '$_REQUEST[su]%' ");
            }
             if($_REQUEST[koni]=="date")
            {
                $data1=mysqli_query("select s.storename,d.durationtime,d.cost,b.billdate from store s,duration d,packagebill b where s.storeid=b.storeid and d.durationid=s.durationid and d.durationid=b.durationid and b.billdate like '$_REQUEST[su]%' ");
            }
...
if ($_REQUEST[tbl] == "sellerbusiness") {
    ...
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from store where username like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);
    ...
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("delete from store ");
        } else {
            mysqli_query("delete from store where storeid=$_REQUEST[id]");
        }
    }
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select st.statename,c.cityname,a.areaname,t.typename,d.durationtime,s.* from state st,city c,area a,store s,storetype t,duration d where st.stateid=s.stateid and c.cityid=s.cityid and a.areaid=s.areaid and t.typeid=s.typeid and d.durationid=s.durationid and s.del=0 and s.active=1   limit $st,$pp");
    } else {
    ...
    while ($row = mysqli_fetch_array($get)) {
        ...
        if ($_REQUEST[uid] == $row[8]) {
            ...
            <?php
            $g = mysqli_query("select * from login where userid like '$row[7]'");
            $gg = mysqli_fetch_array($g);
            if ($gg[4] == 1) {
                ?>
                        <i class="fa fa-thumbs-down" style="cursor:pointer;"></i>
...
?>
    ...
    $c = 0;
            ...
            if($_REQUEST[koni]=="badhu")
            {
                    $data1=mysqli_query("select s.userid,s.storename,t.timeperiodname,t.price,b.billdate,a.adbanner from store s,timeperiod t,bannerbill b,addbanner a where s.storeid=b.storeid and t.timeperiodid=b.timeperiodid and a.timeperiodid=t.timeperiodid");
            }
             if($_REQUEST[koni]=="seller")
            {
                    $data1=mysqli_query("select s.userid,s.storename,t.timeperiodname,t.price,b.billdate,a.adbanner from store s,timeperiod t,bannerbill b,addbanner a where s.storeid=b.storeid and t.timeperiodid=b.timeperiodid and a.timeperiodid=t.timeperiodid and s.userid like '$_REQUEST[su]%'  ");
            }
            if($_REQUEST[koni]=="business")
            {
                $data1=mysqli_query("select s.userid,s.storename,t.timeperiodname,t.price,b.billdate,a.adbanner from store s,timeperiod t,bannerbill b,addbanner a where s.storeid=b.storeid and t.timeperiodid=b.timeperiodid and a.timeperiodid=t.timeperiodid and s.storename like '$_REQUEST[su]%' ");
            }
             if($_REQUEST[koni]=="timeperiod")
            {
                $data1=mysqli_query("select s.userid,s.storename,t.timeperiodname,t.price,b.billdate,a.adbanner from store s,timeperiod t,bannerbill b,addbanner a where s.storeid=b.storeid and t.timeperiodid=b.timeperiodid and a.timeperiodid=t.timeperiodid and t.timeperiodname like '$_REQUEST[su]%' ");
            }
             if($_REQUEST[koni]=="amout")
            {
                $data1=mysqli_query("select s.userid,s.storename,t.timeperiodname,t.price,b.billdate,a.adbanner from store s,timeperiod t,bannerbill b,addbanner a where s.storeid=b.storeid and t.timeperiodid=b.timeperiodid and a.timeperiodid=t.timeperiodid and t.price like '$_REQUEST[su]%' ");
            }
             if($_REQUEST[koni]=="date")
            {
                $data1=mysqli_query("select s.userid,s.storename,t.timeperiodname,t.price,b.billdate,a.adbanner from store s,timeperiod t,bannerbill b,addbanner a where s.storeid=b.storeid and t.timeperiodid=b.timeperiodid and a.timeperiodid=t.timeperiodid and b.billdate like '$_REQUEST[su]%' ");
            }
...
if ($_REQUEST[tbl] == "sreview") {
    ...
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from reviewstore where review like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update reviewstore set review = '$_REQUEST[v]' where reviewstoreid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("delete from reviewstore ");
        } else {
            mysqli_query("delete from reviewstore where reviewstoreid like '$_REQUEST[id]'");
        }
    }

    if ($_REQUEST[work] == "block") {
        $inb = mysqli_query("select * from reviewstore where reviewstoreid=$_REQUEST[id]");
        $inbb = mysqli_fetch_array($inb);
        if ($inbb[5] == 0) {
            $b = mysqli_query("update reviewstore set status=1 where reviewstoreid=$_REQUEST[id]");
        } else {
            $b = mysqli_query("update reviewstore set status=0 where reviewstoreid=$_REQUEST[id]");
        }
    }

    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from reviewstore");
    } else {
        $in = mysqli_query("select count(*) from reviewstore where review like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
    $pp = $_REQUEST[pp];
    $p = $_REQUEST[p];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select u.username,r.* from user u,reviewstore r where u.userid=r.userid limit $st,$pp");
    } else {
        $get = mysqli_query("select u.username,r.* from user u,reviewstore r where u.userid=r.userid and username like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[1]) {
...
if ($_REQUEST[tbl] == "preview") {
    ...
    if ($_REQUEST[work] == "update") {
        $get = mysqli_query("select * from reviewproduct where review like '$_REQUEST[v]'");
        $g = mysqli_fetch_array($get);

        if ($g[0] == "") {
            mysqli_query("update reviewproduct set review = '$_REQUEST[v]' where reviewid = $_REQUEST[id]");
        }
    }
    if ($_REQUEST[work] == "delete") {
        if ($_REQUEST[id] == "all") {
            mysqli_query("delete from reviewproduct ");
        } else {
            mysqli_query("delete from reviewproduct where reviewid like '$_REQUEST[id]'");
        }
    }

    if ($_REQUEST[work] == "block") {
        $inb = mysqli_query("select * from reviewproduct where reviewid=$_REQUEST[id]");
        $inbb = mysqli_fetch_array($inb);
        if ($inbb[5] == 0) {
            $b = mysqli_query("update reviewproduct set active=1 where reviewid=$_REQUEST[id]");
        } else {
            $b = mysqli_query("update reviewproduct set active=0 where reviewid=$_REQUEST[id]");
        }
    }

    if ($_REQUEST[find] == "") {
        $in = mysqli_query("select count(*) from reviewproduct");
    } else {
        $in = mysqli_query("select count(*) from reviewproduct where review like '%$_REQUEST[find]%'  ");
    }
    $a = mysqli_fetch_array($in);
    $pp = $_REQUEST[pp];
    $p = $_REQUEST[p];
    ...
    $c = $st;
    if ($_REQUEST[find] == "") {
        $get = mysqli_query("select u.username,r.* from user u,reviewproduct r where u.userid=r.userid limit $st,$pp");
    } else {
        $get = mysqli_query("select u.username,r.* from user u,reviewproduct r where u.userid=r.userid and username like '%$_REQUEST[find]%'   limit $st,$pp");
    }
    while ($row = mysqli_fetch_array($get)) {
        $c++;
        if ($_REQUEST[uid] == $row[1]) {
...
<?php
   if($_REQUEST[kona]=="adminbill")
   {
        ...
        if($_REQUEST[su]=="last")
       {
           $ubb=mysqli_query("select * from bill where billid=(select  max(billid) from bill)");
           
       }
       if($_REQUEST[su]=="user")
       {
           $ubb=mysqli_query("select * from bill where  userid='$_REQUEST[val]' ");
       }
       if($_REQUEST[su]=="billid")
       {
           $ubb=mysqli_query("select * from bill where  billid=$_REQUEST[val] ");
       }
       if($_REQUEST[su]=="payname")
       {
           $ubb=mysqli_query("select * from bill where paymethod like '$_REQUEST[val]' ");
           
       }
        if($_REQUEST[su]=="date")
       {
           $ubb=mysqli_query("select * from bill where billdate='$_REQUEST[val]' ");
       }
   ?>
                ...
                <div class="col-md-offset-3 col-md-7" >
                    ...
                    $d=0;
                          ...
                          while ($ubill = mysqli_fetch_array($ubb)) 
                        {
                        
                        $cs=  mysqli_query("select c.cityname,a.areaname,s.* from city c,area a,shipping s where c.cityid=s.cityid and a.areaid=s.areaid  ");
                        $csh = mysqli_fetch_array($cs); 
                    ...
                    <div class=" col-md-12" style="background:whitesmoke;padding: 15px;margin-top: 40px">
                        ...
                        <div class="col-md-12">
                           ...
                           $sp=mysqli_query("select i.proname,s.storename,t.* from item i,transaction t,store s where i.productid = t.productid and s.storeid = i.storeid and t.billid=$ubill[1]"); 
                           while ($spp = mysqli_fetch_array($sp)) 
                           {
                               $q=$q+$spp[6];
                               $p=$p+$spp[7];
                               $pb=$pb+($spp[10]);
...
if($_REQUEST[konu]=="feed")
{
    if($_REQUEST[badhu]=="all")
    {
          ...
          $un=mysqli_query("update  feedback set feednotification=1");
    ...
    {
    $un=mysqli_query("update  feedback set feednotification=1 where feedbackid=$_REQUEST[id]");
...
<h5 class="title">You have <?php echo $fb[0]; ?> Feed Back </h5>
                    <ul class="dropdown-list normal-list" >
                        <?php
                         $fb=  mysqli_query("select * from feedback where feednotification=0 order by feedbackid desc limit 0,5");
                         while ($f=  mysqli_fetch_array($fb))
                         {
                             ?>
...
if($_REQUEST[konu]=="store")
{
    if($_REQUEST[badhu]=="all")
    {
          ...
          $un=mysqli_query("update  store set notification=1");
    ...
    {
    $un=mysqli_query("update  store set notification=1 where storeid=$_REQUEST[id]");
...
<h5 class="title">You have <?php echo $s[0]; ?> Store </h5>
                    <ul class="dropdown-list normal-list">
                     <?php
                     $ss=  mysqli_query("select * from store where notification=0 order by storeid desc limit 0,5");
...
if($_REQUEST[konu]=="reviewp")
{
    if($_REQUEST[badhu]=="all")
    {
          ...
          $un=mysqli_query("update reviewproduct set notification=1");
    ...
    {
    $un=mysqli_query("update reviewproduct set notification=1 where reviewid=$_REQUEST[id]");

    $rp=  mysqli_query("select count(*) from reviewproduct where notification=0");
          $r=  mysqli_fetch_array($rp);
          echo $r[0];
    }
}
...
<h5 class="title">You have <?php echo $p[0]; ?> Review Product </h5>
                    <ul class="dropdown-list normal-list">
                        <?php
                     $rpp=  mysqli_query("select u.url,u.username,r.* from user u,reviewproduct r where u.userid=r.userid and r.notification=0  order by r.reviewid desc");
                     while ($pp=  mysqli_fetch_array($rpp))
                     {
                    ?>
...
if($_REQUEST[konu]=="reviews")
{
    if($_REQUEST[badhu]=="all")
    {
          ...
          $un=mysqli_query("update reviewstore set notification=1");
    ...
    {
    $un=mysqli_query("update reviewstore set notification=1 where reviewstoreid=$_REQUEST[id]");
...
<h5 class="title">You have 5 Mails </h5>
                    <ul class="dropdown-list normal-list">
                        <?php
                     $rss=  mysqli_query("select u.url,u.username,r.* from user u,reviewstore r where u.userid=r.userid and r.notification=0  order by r.reviewstoreid desc");
                     while ($ss=  mysqli_fetch_array($rss))
                     {
                    ?>
