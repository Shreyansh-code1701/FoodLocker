...
{
    $get = mysqli_query($conn,"select * from city where cityname like '$_REQUEST[city]'");
    $g = mysqli_fetch_array($get);

    if ($g[0] == "") {
        $ins = mysqli_query($conn,"insert into city values($_REQUEST[stateid],0,'$_REQUEST[city]',0)");
    } else {
        $er = 1;
    }
}
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select required="" name="stateid" class="form-control">
                                                ...
                                                <?php
                                                $get=mysqli_query($conn,"select * from state");
