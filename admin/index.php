...
$state = mysqli_query($conn,"select count(*) from state where del=0");
$ss = mysqli_fetch_array($state);

$city = mysqli_query($conn,"select count(*) from city where del=0");
$cc = mysqli_fetch_array($city);

$area = mysqli_query($conn,"select count(areaid) from area where del=0");
$aa = mysqli_fetch_array($area);
    
$package = mysqli_query($conn,"select count(packagebillid) from packagebill");
