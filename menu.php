...
<header id="ht-header" class="">
                            ...
                            <li class="mega-menu menu-item-has-children">
                                ...
                                <ul>
                                    ...
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul>
                                            <?php $cs=  mysqli_query($conn, "SELECT * from maincategory where del=0 limit 0,4");
 while ($ro = mysqli_fetch_array($cs)) 
     {                                       ?>
                                    ...
                                    <li class="menu-item-has-children">
                                        <ul>
                                            <?php $cs=  mysqli_query($conn, "SELECT * from maincategory where del=0 limit 4,4");
 while ($ro1 = mysqli_fetch_array($cs)) 
     {                                       ?>
                                    ...
                                    <li class="menu-item-has-children">
                                        <ul>
                                            <?php $cs=  mysqli_query($conn, "SELECT * from maincategory where del=0 limit 8,4");
 while ($ro1 = mysqli_fetch_array($cs)) 
     {                                       ?>
                                            <li style="text-transform: capitalize;"><a href="filter.php?search=<?php echo $ro1[1]; ?> "><font class="submenu" style="color: #232323;"><i class="fa fa-cutlery"></i>&nbsp;&nbsp; <?php echo $ro1[1]; ?></font></a></li>
                                         <?php
                                    ...
                                    <li class="menu-item-has-children">
                                        <ul>
                                            <?php $cs=  mysqli_query($conn, "SELECT * from maincategory where del=0 limit 12,4");
 while ($ro1 = mysqli_fetch_array($cs)) 
     {                                       ?>
                                            <li style="text-transform: capitalize;"><a href="filter.php?search=<?php echo $ro1[1]; ?> "><font class="submenu" style="color: #232323;"><i class="fa fa-cutlery"></i>&nbsp;&nbsp; <?php echo $ro1[1]; ?></font></a></li>
                                         <?php
                                    ...
                                    <li class="menu-item-has-children">
                                        <ul>
                                            <?php $cs=  mysqli_query($conn, "SELECT * from store where del=0 limit 0,4");
 while ($ro1 = mysqli_fetch_array($cs)) 
     {                                       ?>
