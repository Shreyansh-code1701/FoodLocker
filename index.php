...
<body class="smooth-scroll" onload="avgrate('sratedekho');">
    ...
    <div class="ht-page-wrapper">
                ...
                <div class="container">
                    <div class="row">
                        <div class="isotope-grid" id="grid-1">
                            ...
                            $get =  mysqli_query($conn, "select t.typename,d.durationtime,s.statename,c.cityname,a.areaname,ss.* from storetype t,duration d,state s,city c,area a,store ss where t.typeid=ss.typeid and d.durationid=ss.durationid and s.stateid=ss.stateid and c.cityid=ss.cityid and a.areaid=ss.areaid and ss.active=1");
                                ...
                                <div class="entry col-xs-12 col-sm-4 animated zoomInDown col-xs-4 filter-food filter-pudding">
                                    <div class="entry-inner">
                                        ...
                                        <div class="content-wrapper col-md-12 col-sm-12 col-xs-12 " style="border: 1px dotted #f8a631;">
                                            <h3 class="entry-name" style="text-transform: capitalize;"><a href="product.php?stid=<?php echo $row[8]; ?>">
                                                    <p style="text-transform: capitalize;"><?php echo $row[9]; ?></p>
                                                </a></h3>
                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <?php
                                                        $avs =  mysqli_query($conn, "select avg(rate) from ratestore where storeid=$row[8]");
                                                    ...
                                                    <div class="col-md-4">
                                                        <?php
                                                        $rve =  mysqli_query($conn, "select count(reviewstoreid) from reviewstore where  status=1 and storeid=$row[8] ");
                                                        $rv =  mysqli_fetch_array($rve); {
                                                        ?>
                                                            <p>(<?php echo  $rv[0]; ?>)Review</p>
                                                        <?php
                                                        }
                                                        ?>
                                                    </div>
        ...
        <?php $ev =  mysqli_query($conn, "select s.storename,e.eventname,eb.* from  store s,event e,eventbook eb where s.storeid=eb.storeid and e.eventid=eb.eventid and eb.confirm=0 and eb.userid like '$_SESSION[user]' ");
        $e =  mysqli_fetch_array($ev);
        ?>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="hs-content">
                            ...
                            <div class="entry feature">
                                ...
                                <p style="font-size: 14px;">Store Name :</p>
                                <p class="meta meta-time" style="text-transform: capitalize;"><?php echo $e[0]; ?></p>
                                <p style="font-size: 14px;">Date :</p>
                                <p class="meta meta-location" style="text-transform: capitalize;"><?php echo $e[7]; ?></p>
                                <p style="font-size: 14px;">Charge :</p>
                                <p class="meta meta-location" style="text-transform: capitalize;"><?php echo $e[6]; ?></p>

                            </div>
                            <p class="foo-heading">OTHER EVENTS</p>
                            <a href="#" class="entry">
                                <h3 class="entry-name">Dinner</h3>
                                <p class="meta-time">Saturday, September 20, 2014.</p>
                            </a>
        ...
        <section class="ht-section hs-parallax hs-gallery" style="background-image: url('images/parallax/1.jpg')">
            ...
            <header class="hs-header">
                <div class="container">
                    <h2 class="heading">OUR GALLERY FROM INSTAGRAM</h2>
                </div>
            </header>
            <div class="hs-content">
