...
if(isset($_REQUEST[rev]))
{
    ...
    if($r!=1)
    {
        $r=mysqli_query($conn, "insert into review values('$_SESSION[user]','$_REQUEST[pid]',0,'$_REQUEST[review]',0)");
        ...
        <div class="container">
            ...
            <div class="col-md-12 wow fadeInRight" data-wow-delay="0.4s">
                <div class="educate_grid">
                    <?php
                        $sel=mysqli_query($conn, "select * from store where active=1");
                        while($sell=mysqli_fetch_array($sel))
                        {
                    ?>
            <div class="col-md-6">
