...
<div class="educate_grid" style="padding: 15px;">
    ...
    {
        $k=  mysqli_query($conn, "select s.statename,c.cityname,a.areaname,ss.* from state s,city c,area a,store ss where s.stateid=ss.stateid and c.cityid=ss.cityid and a.areaid=ss.areaid and ss.storeid=$_REQUEST[kona]");
                                     ...
                                     <table class="table table-responsive" style="width: 70%;">
                                         ...
                                         <tr>
                                             ...
                                             <td style="border:0; ">
                                                 <p >
                                                <?php 
                                                $cus=  mysqli_query($conn, "select  m.mcatname,s.storename from maincategory m,store s,cuisine c where m.mcatid=c.mcatid and s.storeid=c.storeid and s.storeid=$_SESSION[id] ");
                                                while ($cu=  mysqli_fetch_array($cus))
                                                 {
    ...
    <div class="container">   
            <div class="row">
                ...
                <?php
                $st=  mysqli_query($conn, "select storename from store where active=1");
                $sell= mysqli_fetch_array($st);
                ?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-10">
                            <table class="table table-responsive">
                                ...
                                <?php
                                $info1=  mysqli_query($conn, "select count(*) from user r,reviewstore rw where r.userid=rw.userid and rw.storeid=$_REQUEST[kona] and rw.status=1");
                               $infodata1=  mysqli_fetch_array($info1);
                               ...
                               else
                               {
                                ...
                                $info=  mysqli_query($conn, "select r.username,r.url,rw.* from user r,reviewstore rw where r.userid=rw.userid and rw.storeid=$_SESSION[id] and rw.status=1 limit $s,5");
                                while($infodata=  mysqli_fetch_array($info))
                                {
                                ?>
    ...
    <div class="row">
        ...
        <div class="col-md-offset-4 col-md-4">
              ...
              <?php
               $e=mysqli_query($conn, "select e.* from event e,storeevent s where s.eventid = e.eventid and s.storeid = $_REQUEST[kona]");
               while($eb=mysqli_fetch_array($e))
               {
...
?>
    ...
    <div >
        <div >
                    <?php
                        $bro=  mysqli_query($conn, "select * from brochure where storeid = $_REQUEST[kona]");
                        while($br=  mysqli_fetch_array($bro))
                        {
                            $s=  mysqli_query($conn, "select storeimage,storename from store where storeid=$_REQUEST[kona]");
                    ...
                    <div class="row"  style="background: #eee;box-shadow:2px 2px 2px #333;">
                        ...
                        <form action="" method="post" name="eventbooks" class="maru">
                            ...
                            <div class="col-md-offset-1 col-md-10" style="margin-top:5%;background: #eee;margin-bottom: 5%;">   
                                    ...
                                    <?php
                                        $eb =mysqli_query($conn, "select ss.storename,ss.storeid,ee.price,e.* from store ss,eventprice ee,event e,storeevent s where s.eventid = e.eventid and e.eventid=ee.eventid and ss.storeid=s.storeid and ss.storeid=$_SESSION[id] and e.eventid=$_REQUEST[idd]");
