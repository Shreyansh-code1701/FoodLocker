            ...
            <div class="main-content" >
                ...
                <div class="wrapper">
                    ...
                    <div class="row">
                        ...
                        <?php
                        $sel=  mysqli_query("select s.typename,d.durationtime,st.statename,c.cityname,a.areaname,ss.* from storetype s,duration d,state st,city c,area a,store ss where s.typeid=ss.typeid and d.durationid=ss.durationid and st.stateid=ss.stateid and c.cityid=ss.cityid and a.areaid=ss.areaid and active=1 and userid like '$_SESSION[user]'");
