...
$pr=mysqli_query("select * from user where userid like '$_SESSION[user]'");
...
if (isset($_REQUEST[send])) 
  ...
  $up = mysqli_query("update user set username='$_REQUEST[name]',address='$_REQUEST[address]',gender='$_REQUEST[gender]',state='$_REQUEST[state]',city='$_REQUEST[city]',area='$_REQUEST[area]',email='$_REQUEST[email]',mobile='$_REQUEST[mobile]',password='$_REQUEST[password]',sque='$_REQUEST[sqq]',sans='$_REQUEST[sqa]',url='$oldpath' where userid like '$_SESSION[user]' ");
$upp=mysqli_query("update login set password='$_REQUEST[password]' where userid like '$_SESSION[user]'");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="city" class="form-control" required="">
                                                    <?php
                                                    $get = mysqli_query("select * from city  where del=0 and stateid='$inn[3]' ");
                                                    while ($row = mysqli_fetch_array($get)) {
                                                        if($inn[4]==$row[1])
                                                        {
                                                        ?>
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="area" class="form-control" required="">
                                                    <?php
                                                    $get = mysqli_query("select * from area  where del=0 and cityid='$inn[4]' ");
                                                    while ($row = mysqli_fetch_array($get)) {
                                                        if($inn[5]==$row[1])
                                                        {
                                                        ?>
