        ...
        <section>
            ...
            <div class="main-content" >
                ...
                <div class="wrapper">
                        ...
                        <section class="panel state">
                            ...
                            <div class="panel-body">
                                ...
                                <?php
                                $get=mysqli_query ("select st.statename,c.cityname,a.areaname,s.* from state st,city c,area a,store s where st.stateid=s.stateid and c.cityid=s.cityid and a.areaid=s.areaid and s.storeid=(select max(storeid) from store where userid like '$_SESSION[user]')");
                ...
                <td   style="text-align: center; padding-top: 38px;">
                                    ...
                                    <?php
                                    $g = mysqli_query("select * from duration where durationid=$row[4]");
