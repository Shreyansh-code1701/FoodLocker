                                ...
                                <div class="panel-body">
                                    <ul class="p-info sellerinfo">
                                        ...
                                        <li>
                                            ...
                                            <?php $innn=  mysqli_query("select * from state where stateid=$inn[3]");
                                        ...
                                        <li>
                                            <div class="title">City</div>
                                             <?php $innn=  mysqli_query("select * from city where cityid=$inn[4]");
                                            $cc=  mysqli_fetch_array($innn);
                                            ?>
                                        ...
                                        <li>
                                            ...
                                            <?php $innn=  mysqli_query("select * from area where areaid=$inn[5]");
                                            $cc=  mysqli_fetch_array($innn);
                                            ?>
                                            <div class="desk"><?php echo $cc[2]; ?></div>
                                        </li>
