...
{
//     $get = mysqli_query("select * from offer where offername like '$_REQUEST[offer]' and cost=$_REQUEST[cost]");
//    $g = mysqli_fetch_array($get);
//
//    if ($g[0] == "") {
        $ins =mysqli_query("insert into offer values('$_REQUEST[mcat]','$_REQUEST[store]',0,'$_REQUEST[offname]','$_REQUEST[sdate]','$_REQUEST[edate]',$_REQUEST[lprice],$_REQUEST[hprice],$_REQUEST[rate],1)");
...
{
//     $get = mysqli_query("select * from duration where durationtime like '$_REQUEST[durationupdate]' and cost=$_REQUEST[costupdate]");
//    $g = mysqli_fetch_array($get);
//
//    if ($g[0] == "") {
        $ins =mysqli_query("update offer set mcatid=$_REQUEST[upmcat],storeid=$_REQUEST[upstore],offername='$_REQUEST[upoffname]',startdate='$_REQUEST[upsdate]',enddate='$_REQUEST[upedate]',lowprice=$_REQUEST[uplprice],highprice=$_REQUEST[uphprice],rate=$_REQUEST[uprate] where offerid=$_SESSION[uid]");
//    }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
//    else
//    {
//        $er1=1;
