...
$pr=mysqli_query("select storeimage from store where storeid=$row[8]");
            ...
            <div class="main-content" >
                ...
                <div class="wrapper">
                    ...
                    <div class="row">
                        ...
                        <?php
                        $get=  mysqli_query("select s.typename,d.durationtime,st.statename,c.cityname,a.areaname,ss.* from storetype s,duration d,state st,city c,area a,store ss where s.typeid=ss.typeid and d.durationid=ss.durationid and st.stateid=ss.stateid and c.cityid=ss.cityid and a.areaid=ss.areaid and active=1 and userid like '$_SESSION[user]'");
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select name="state" class="form-control" required="" >
                                                        <?php
                                                        $state = mysqli_query("select * from state  where del=0  ");
...
<?php
$city = mysqli_query("select * from city  where del=0 and stateid='$row[10]' ");
...
<?php
$area = mysqli_query("select * from area  where del=0 and cityid='$row[11]' ");
while ($aa = mysqli_fetch_array($area)) {
    if ($row[12] == $aa[1]) {
        ?>
