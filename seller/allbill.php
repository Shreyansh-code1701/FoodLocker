                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2 sea">
                                    <select  name="billid" onchange="sellbill('sellbill','user',this.value);" class="form-control">
                                        ...
                                        <?php
                                        $cs = mysqli_query("select s.userid,s.storeid,t.* from bill b,transaction t,store s,item p where p.productid=t.productid and s.storeid=p.storeid and b.billid=t.billid and s.userid like '$_SESSION[user]' ");
                                        while ($bdd = mysqli_fetch_array($cs)) {
                                            ?>
                                        ...
                                        <?php
                                        $cp = mysqli_query("select distinct paymethod from bill ");
                                        while ($bp = mysqli_fetch_array($cp)) {
                                            ?>
                             ...
                             <header class="panel-heading" style="background: #e0e1e7 !important;">
                                ...
                                <div class="col-md-offset-7 col-md-4 col-sm-10 col-xs-10">
                                    ...
                                    <select style="padding: 8px;" name="sellerid" class="form-control" onchange="sellbill('sellbill','store',this.value);">
                                        ...
                                        <?php
                                        $get = mysqli_query("select * from store where userid like '$_SESSION[user]'");
