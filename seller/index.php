...
$pb=  mysqli_query("select count(*) from bannerbill");
                        ...
                        <div class="col-md-3">
                            <div class="panel red-bg">
                                <div class="panel-body">
                                    <div class="row">
                                        <?php
                                        $pack=  mysqli_query("select count(packagebillid) from packagebill where userid like '$_SESSION[user]'");
                                        $pp=  mysqli_fetch_array($pack);
                                        ?>
                                        <div class="col-xs-4">
