    ...
    if (strlen($_FILES[storeimage][name]) > 0) {
        ...
        if ($ex == ".png" || $ex == ".jpg" || $ex == ".jpeg" || $ex == ".PNG" || $ex == ".JPG" || $ex == ".JPEG") {
            if (round($siz = $_FILES[storeimage][size] / 1024) >= 0) {
                ...
                $get = mysqli_query("select max(storeid) from store");

                $gett = mysqli_fetch_array($get);
  ...
  if($er2!=1 && $er3!= 1 && $er4!= 1 && $er5!= 1 && $er6!= 1&& $er7!= 1 && $er8!= 1)
    {
      ...
      $ins =mysqli_query("insert into store values($_REQUEST[storetype],$_REQUEST[duration],'$_SESSION[user]',0,'$_REQUEST[name]',$_REQUEST[state],$_REQUEST[city],$_REQUEST[area],'$_REQUEST[address]','$_REQUEST[storemap]','$_REQUEST[email]','$_REQUEST[mobile]','$_REQUEST[website]','$path1','$path3',0,0,0,'$_REQUEST[timeduration]','$_REQUEST[registration]',0,'$_REQUEST[since]','$_REQUEST[fax]','$_REQUEST[regdate]','0000-00-00','0000-00-00','$_REQUEST[foodtype]','$path5')");
         
      
         $smx=mysqli_query("select max(storeid) from store");
         $smxx=(mysqli_fetch_array($smx));
         if(isset($_REQUEST[highlight]))
         {
                 foreach ($_REQUEST[highlight] as $val )
                 {
                     $hia=mysqli_query("insert into  highlightassign values($val,$smxx[0],0,0)");
                 }
         }
                                        ...
                                        <div class="panel-body" >
                                                    ...
                                                    <div class="input-group">
                                                        <select name="storetype" class="form-control" required="">
                                                            ...
                                                            <?php
                                                            $get = mysqli_query("select * from storetype where del=0");
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="duration" class="form-control" required="">
                                                            ...
                                                            <?php
                                                            $get = mysqli_query("select * from duration where del=0");
                                                            while ($row = mysqli_fetch_array($get)) {
                                                                ?>
                                                                <option value="<?php echo $row[0]; ?>" style="text-transform: capitalize;"><?php echo $row[1]; ?></option>
                                                                <?php
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <select name="state" class="form-control" required="" onchange="getcity('city',this.value);getcity('area', 0);">
                                                                ...
                                                                <?php
                                                                $get = mysqli_query("select * from state  where del=0");
                                                                while ($row = mysqli_fetch_array($get)) {
                                                                    ?>
                                                                    <option value="<?php echo $row[0]; ?>"  style="text-transform: capitalize;"><?php echo $row[1]; ?></option>
                                                                    <?php
                                            ...
                                            <ul class="p-info">
                                                ...
                                                <div class="row">
                                                   <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <?php
                                                        $hh=mysqli_query("select * from highlight where del=0");
                                                        while ($hhl = mysqli_fetch_array($hh))
                                                        {
                                                        ?>
