...
{
//     $get = mysqli_query("select * from eventprice where price=$_REQUEST[price]");
//    $g = mysqli_fetch_array($get);
//
//    if ($g[0] == "") {
        $ins =mysqli_query("insert into eventprice values($_REQUEST[store],$_REQUEST[event],$_REQUEST[price],0)");
