...
$sel=mysqli_query($conn, "select * from store where storeid=$_SESSION[id]");
                    ...
                    <div class="col-md-5 raterev">
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table table-responsive">
                                ...
                                <?php
                                $info1=  mysqli_query($conn, "select count(*) from user r,reviewstore rw where r.userid=rw.userid and rw.storeid=$_SESSION[id] and rw.status=1");
                     ...
                     <div class="col-md-4 raterev">
                        ...
                        <?php
                       $sel1=mysqli_query($conn, "select * from store where storeid=$_SESSION[id]");
