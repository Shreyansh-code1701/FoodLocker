...
$pr=mysqli_query($conn, "select * from user where userid like '$_SESSION[user]'");
...
if (isset($_REQUEST[send])) 
   ...
   $up = mysqli_query($conn, "update user set username='$_REQUEST[name]',address='$_REQUEST[address]',gender='$_REQUEST[gender]',state='$_REQUEST[state]',city='$_REQUEST[city]',area='$_REQUEST[area]',email='$_REQUEST[email]',mobile='$_REQUEST[mobile]',password='$_REQUEST[password]',sque='$_REQUEST[sqq]',sans='$_REQUEST[sqa]',url='$oldpath' where userid like '$_SESSION[user]' ");
   $upp=mysqli_query($conn, "update login set password='$_REQUEST[password]' where userid like '$_SESSION[user]'");
                ...
                <div class="container">
                    <div class="inner">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center " >
                            <i class="fa fa-star" ></i>&nbsp;&nbsp;<p style="font-size:30px;">U</p><b style="color: #F8A631;">SER</b>&nbsp;<font style="font-size:30px;">P</font><b style="color:#F8A631;">R<i class="fa fa-circle" ></i>FILE</b>&nbsp;&nbsp;<i class="fa fa-star"></i> 
                        </div>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                        ...
                                        <div class="sellerprofile-pic text-center " style="padding: 10px;">
                                            ...
                                            <?php
                                            $in = mysqli_query($conn, "select * from user where userid like '$_SESSION[user]' ");
                                      ...
                                      <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="state" class="form-control" required="" >
                                                    <?php
                                                    $get = mysqli_query($conn, "select * from state  where del=0  ");
                                      ...
                                      <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="city" class="form-control" required="">
                                                    <?php
                                                    $get = mysqli_query($conn, "select * from city  where del=0 and stateid='$inn[3]' ");
                                                    while ($row = mysqli_fetch_array($get)) {
                                                        if($inn[4]==$row[1])
                                                        {
                                                        ?>
                                      ...
                                      <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="area" class="form-control" required="">
                                                    <?php
                                                    $get = mysqli_query($conn, "select * from area  where del=0 and cityid='$inn[4]' ");
                                                    while ($row = mysqli_fetch_array($get)) {
                                                        if($inn[5]==$row[1])
                                                        {
                                                        ?>
